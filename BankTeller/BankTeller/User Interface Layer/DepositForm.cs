        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtNum.Text))
            {
                ...
                if (depositAmount > 0)
                {
                    ...
                    DialogResult result = MessageBox.Show("Deposit transaction successful. New balance: " + AccountEntity.Balance + ". Do you wish to do another transaction?", "Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
